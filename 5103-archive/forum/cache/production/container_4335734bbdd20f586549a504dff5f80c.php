...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbbre_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'phpbbre_forums', 'phpbbre_posts', 'phpbbre_topics', 'phpbbre_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbbre_captcha_questions', 'phpbbre_captcha_answers', 'phpbbre_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbbre_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbbre_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'phpbbre_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_bbcodes', 'phpbbre_smilies', 'phpbbre_styles', 'phpbbre_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbre_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbbre_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'phpbbre_acl_groups',
            'tables.acl_options' => 'phpbbre_acl_options',
            'tables.acl_roles' => 'phpbbre_acl_roles',
            'tables.acl_roles_data' => 'phpbbre_acl_roles_data',
            'tables.acl_users' => 'phpbbre_acl_users',
            'tables.attachments' => 'phpbbre_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbbre_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbbre_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbbre_oauth_accounts',
            'tables.banlist' => 'phpbbre_banlist',
            'tables.bbcodes' => 'phpbbre_bbcodes',
            'tables.bookmarks' => 'phpbbre_bookmarks',
            'tables.bots' => 'phpbbre_bots',
            'tables.captcha_qa_questions' => 'phpbbre_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbbre_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbbre_qa_confirm',
            'tables.config' => 'phpbbre_config',
            'tables.config_text' => 'phpbbre_config_text',
            'tables.confirm' => 'phpbbre_confirm',
            'tables.disallow' => 'phpbbre_disallow',
            'tables.drafts' => 'phpbbre_drafts',
            'tables.ext' => 'phpbbre_ext',
            'tables.extensions' => 'phpbbre_extensions',
            'tables.extension_groups' => 'phpbbre_extension_groups',
            'tables.forums' => 'phpbbre_forums',
            'tables.forums_access' => 'phpbbre_forums_access',
            'tables.forums_track' => 'phpbbre_forums_track',
            'tables.forums_watch' => 'phpbbre_forums_watch',
            'tables.groups' => 'phpbbre_groups',
            'tables.icons' => 'phpbbre_icons',
            'tables.lang' => 'phpbbre_lang',
            'tables.log' => 'phpbbre_log',
            'tables.login_attempts' => 'phpbbre_login_attempts',
            'tables.migrations' => 'phpbbre_migrations',
            'tables.moderator_cache' => 'phpbbre_moderator_cache',
            'tables.modules' => 'phpbbre_modules',
            'tables.notification_emails' => 'phpbbre_notification_emails',
            'tables.notification_types' => 'phpbbre_notification_types',
            'tables.notifications' => 'phpbbre_notifications',
            'tables.poll_options' => 'phpbbre_poll_options',
            'tables.poll_votes' => 'phpbbre_poll_votes',
            'tables.posts' => 'phpbbre_posts',
            'tables.privmsgs' => 'phpbbre_privmsgs',
            'tables.privmsgs_folder' => 'phpbbre_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbbre_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbbre_privmsgs_to',
            'tables.profile_fields' => 'phpbbre_profile_fields',
            'tables.profile_fields_data' => 'phpbbre_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbbre_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbbre_profile_lang',
            'tables.ranks' => 'phpbbre_ranks',
            'tables.reports' => 'phpbbre_reports',
            'tables.reports_reasons' => 'phpbbre_reports_reasons',
            'tables.search_results' => 'phpbbre_search_results',
            'tables.search_wordlist' => 'phpbbre_search_wordlist',
            'tables.search_wordmatch' => 'phpbbre_search_wordmatch',
            'tables.sessions' => 'phpbbre_sessions',
            'tables.sessions_keys' => 'phpbbre_sessions_keys',
            'tables.sitelist' => 'phpbbre_sitelist',
            'tables.smilies' => 'phpbbre_smilies',
            'tables.sphinx' => 'phpbbre_sphinx',
            'tables.styles' => 'phpbbre_styles',
            'tables.styles_template' => 'phpbbre_styles_template',
            'tables.styles_template_data' => 'phpbbre_styles_template_data',
            'tables.styles_theme' => 'phpbbre_styles_theme',
            'tables.styles_imageset' => 'phpbbre_styles_imageset',
            'tables.styles_imageset_data' => 'phpbbre_styles_imageset_data',
            'tables.teampage' => 'phpbbre_teampage',
            'tables.topics' => 'phpbbre_topics',
            'tables.topics_posted' => 'phpbbre_topics_posted',
            'tables.topics_track' => 'phpbbre_topics_track',
            'tables.topics_watch' => 'phpbbre_topics_watch',
            'tables.user_group' => 'phpbbre_user_group',
            'tables.user_notifications' => 'phpbbre_user_notifications',
            'tables.users' => 'phpbbre_users',
            'tables.warnings' => 'phpbbre_warnings',
            'tables.words' => 'phpbbre_words',
            'tables.zebra' => 'phpbbre_zebra',
            ...
            'tables' => [
                'acl_groups' => 'phpbbre_acl_groups',
                'acl_options' => 'phpbbre_acl_options',
                'acl_roles' => 'phpbbre_acl_roles',
                'acl_roles_data' => 'phpbbre_acl_roles_data',
                'acl_users' => 'phpbbre_acl_users',
                'attachments' => 'phpbbre_attachments',
                'auth_provider_oauth_token_storage' => 'phpbbre_oauth_tokens',
                'auth_provider_oauth_states' => 'phpbbre_oauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbbre_oauth_accounts',
                'banlist' => 'phpbbre_banlist',
                'bbcodes' => 'phpbbre_bbcodes',
                'bookmarks' => 'phpbbre_bookmarks',
                'bots' => 'phpbbre_bots',
                'captcha_qa_questions' => 'phpbbre_captcha_questions',
                'captcha_qa_answers' => 'phpbbre_captcha_answers',
                'captcha_qa_confirm' => 'phpbbre_qa_confirm',
                'config' => 'phpbbre_config',
                'config_text' => 'phpbbre_config_text',
                'confirm' => 'phpbbre_confirm',
                'disallow' => 'phpbbre_disallow',
                'drafts' => 'phpbbre_drafts',
                'ext' => 'phpbbre_ext',
                'extensions' => 'phpbbre_extensions',
                'extension_groups' => 'phpbbre_extension_groups',
                'forums' => 'phpbbre_forums',
                'forums_access' => 'phpbbre_forums_access',
                'forums_track' => 'phpbbre_forums_track',
                'forums_watch' => 'phpbbre_forums_watch',
                'groups' => 'phpbbre_groups',
                'icons' => 'phpbbre_icons',
                'lang' => 'phpbbre_lang',
                'log' => 'phpbbre_log',
                'login_attempts' => 'phpbbre_login_attempts',
                'migrations' => 'phpbbre_migrations',
                'moderator_cache' => 'phpbbre_moderator_cache',
                'modules' => 'phpbbre_modules',
                'notification_emails' => 'phpbbre_notification_emails',
                'notification_types' => 'phpbbre_notification_types',
                'notifications' => 'phpbbre_notifications',
                'poll_options' => 'phpbbre_poll_options',
                'poll_votes' => 'phpbbre_poll_votes',
                'posts' => 'phpbbre_posts',
                'privmsgs' => 'phpbbre_privmsgs',
                'privmsgs_folder' => 'phpbbre_privmsgs_folder',
                'privmsgs_rules' => 'phpbbre_privmsgs_rules',
                'privmsgs_to' => 'phpbbre_privmsgs_to',
                'profile_fields' => 'phpbbre_profile_fields',
                'profile_fields_data' => 'phpbbre_profile_fields_data',
                'profile_fields_options_language' => 'phpbbre_profile_fields_lang',
                'profile_fields_language' => 'phpbbre_profile_lang',
                'ranks' => 'phpbbre_ranks',
                'reports' => 'phpbbre_reports',
                'reports_reasons' => 'phpbbre_reports_reasons',
                'search_results' => 'phpbbre_search_results',
                'search_wordlist' => 'phpbbre_search_wordlist',
                'search_wordmatch' => 'phpbbre_search_wordmatch',
                'sessions' => 'phpbbre_sessions',
                'sessions_keys' => 'phpbbre_sessions_keys',
                'sitelist' => 'phpbbre_sitelist',
                'smilies' => 'phpbbre_smilies',
                'sphinx' => 'phpbbre_sphinx',
                'styles' => 'phpbbre_styles',
                'styles_template' => 'phpbbre_styles_template',
                'styles_template_data' => 'phpbbre_styles_template_data',
                'styles_theme' => 'phpbbre_styles_theme',
                'styles_imageset' => 'phpbbre_styles_imageset',
                'styles_imageset_data' => 'phpbbre_styles_imageset_data',
                'teampage' => 'phpbbre_teampage',
                'topics' => 'phpbbre_topics',
                'topics_posted' => 'phpbbre_topics_posted',
                'topics_track' => 'phpbbre_topics_track',
                'topics_watch' => 'phpbbre_topics_watch',
                'user_group' => 'phpbbre_user_group',
                'user_notifications' => 'phpbbre_user_notifications',
                'users' => 'phpbbre_users',
                'warnings' => 'phpbbre_warnings',
                'words' => 'phpbbre_words',
                'zebra' => 'phpbbre_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbbre_',
